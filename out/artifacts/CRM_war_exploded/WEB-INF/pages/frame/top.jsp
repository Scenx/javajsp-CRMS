...
<HEAD>
    ...
    <script>
        function modifypsw() {
            var dw = window.showModalDialog('${pageContext.request.contextPath}/pages/staff_updPwd', '', 'dialogHeight:180px; dialogWidth:260px; dialogLeft:500px; dialogTop:220px;edge:sunken;center:yes;location:no;help:no;resizable:no;status:no;scroll:no');
        }
    </script>
