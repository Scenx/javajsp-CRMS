...
<table width="100%" border="1">
    ...
    <tr class="tabtd1">
        ...
        <td align="center">
            <a href="${pageContext.request.contextPath}/pages/student/addOrEditStudent.jsp"><img
                    src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
        </td>

        <td align="center">
            <a href="${pageContext.request.contextPath}/pages/station/editStation.jsp"><img
                    src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
        </td>
        <!-- 查询详情 -->
        <td align="center">
            <a href="${pageContext.request.contextPath}/pages/student/showStudent.jsp"><img
                    src="${pageContext.request.contextPath}/images/button/view.gif" class="img"/></a>
        </td>

        <td align="center">
            <a href="${pageContext.request.contextPath}/pages/runoff/addRunoff.jsp"><img
                    src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
        </td>
    </tr>
